...
# Create a section to display street light data
street_light_data_frame = ttk.Frame(window, borderwidth=2, relief="ridge", padding=5)
street_light_data_frame.grid(row=0, column=2, rowspan=5, padx=10, pady=10, sticky="nsew")

# Create headers for the street light data
street_light_id_label = ttk.Label(street_light_data_frame, text="Street Light ID", font=("Arial", 12, "bold"), foreground="black")
street_light_id_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")

street_light_geo_tag_label = ttk.Label(street_light_data_frame, text="Street Light Geo Tag", font=("Arial", 12, "bold"), foreground="black")
street_light_geo_tag_label.grid(row=0, column=1, padx=5, pady=5, sticky="w")

street_light_status_label = ttk.Label(street_light_data_frame, text="Street Light Status", font=("Arial", 12, "bold"), foreground="black")
street_light_status_label.grid(row=0, column=2, padx=5, pady=5, sticky="w")

# Create data for 100 street lights (IDs and random geotags)
for i in range(1, 101):
    street_light_id = f"HRKRTH{i:04d}"
    ...
    id_label = ttk.Label(street_light_data_frame, text=street_light_id, foreground="black")
    id_label.grid(row=i, column=0, padx=5, pady=5, sticky="w")

    geo_tag_label = ttk.Label(street_light_data_frame, text=street_light_geo_tag, foreground="black")
    geo_tag_label.grid(row=i, column=1, padx=5, pady=5, sticky="w")

    status_label = ttk.Label(street_light_data_frame, text=street_light_status, foreground="black")
    status_label.grid(row=i, column=2, padx=5, pady=5, sticky="w")
